...
The MVP marker cards live in `Assets/Resources/Markers` and are designed to look like their tools while keeping enough high-contrast border detail for AR image tracking:
